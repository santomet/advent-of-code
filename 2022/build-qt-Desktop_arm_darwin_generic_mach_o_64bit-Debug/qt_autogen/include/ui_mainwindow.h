...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        textEdit->setGeometry(QRect(80, 220, 251, 111));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(90, 60, 231, 16));
        verticalLayoutWidget = new QWidget(centralwidget);
        verticalLayoutWidget->setObjectName("verticalLayoutWidget");
        verticalLayoutWidget->setGeometry(QRect(90, 100, 228, 103));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QCoreApplication::translate("MainWindow", "This is application for Advent of Code", nullptr));
